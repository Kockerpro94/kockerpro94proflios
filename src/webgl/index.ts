...
export default function WebGL() {
  loadAssists((assists) => {
    ...
    // Add the entire imported scene so any newly added models are included
    if (assists.gltfScene) {
      computerGroup.add(assists.gltfScene);
    }
    ...
    const tick = () => {
      ...
      if (assists.crtMesh && assists.crtMesh.morphTargetInfluences) {
